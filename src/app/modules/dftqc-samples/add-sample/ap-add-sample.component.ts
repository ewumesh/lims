...
export class ApAddSampleComponent implements OnInit, AfterViewInit {
    ...
    manipulateSampleDetails(response) {
        ...
        let selectedCommodity = this.commodities.find(a => a.id === response.commodity.id);
        ...
        this.selectedCommodity = this.commodities.find(a => a.id === response.commodity.id);
        ...
        if(formValue.analysis_pricing === true) {
            ...
            // this.parameterWisePrice = response?.price;;
            console.log(response.price, 'C')
        } else {
            console.log(response.price, 'P')
            formValue.analysis_pricing = 0;
            // this.commodityWisePrice = response?.price;
        } 
        
        console.log(this.selectedCommodity, 'SSS')
    ...
    setTableHeader() {
        this.apAddSampleForm.get('analysis_pricing').valueChanges.subscribe(res => {
    ...
    getSelectedCommodityParameters() {
        this.cCtrl.valueChanges.subscribe(a => {console.log(a, 'iooooo')
    ...
    saveChanges() {
        ...
        formData.append('mfd', this.format(this.apAddSampleForm.value.mfd));
        if (this.apAddSampleForm.value.dfb) {
            formData.append('dfb', this.format(this.apAddSampleForm.value.dfb));
        } else {
            // formData.append('dfb', '');
        }
        ...
        // formData.append('batch', this.apAddSampleForm.value.batch);
        // formData.append('brand', this.apAddSampleForm.value.brand),
        // formData.append('purpose', this.apAddSampleForm.value.purpose),
        ...
        formData.append('amendments', this.apAddSampleForm.value.amendments)
            ...
            formData.append('requested_export', this.apAddSampleForm.value.requested_export)
            if(this.sampleId) {
            ...
            formData.append('sample_quantity', this.apAddSampleForm.value.sample_quantity),
            formData.append('sample_units', this.apAddSampleForm.value.sample_units),
            formData.append('number_of_sample', this.apAddSampleForm.value.number_of_sample),
        ...
        formData.append('client_sub_category', this.apAddSampleForm.value.client_sub_category),

            formData.append('analysis_fee', this.apAddSampleForm.value.analysis_fee),
            formData.append('voucher_number', this.apAddSampleForm.value.voucher_number),
            formData.append('voucher_date', this.format(this.apAddSampleForm.value.voucher_date)),
            formData.append('analysis_pricing', this.apAddSampleForm.value.analysis_pricing)
            ...
            this.service.addSample(formData).subscribe(res => {
                this.toast.showToast(TOAST_STATE.success, res.message);
                this.dismissMessage();
                this.isSampleSent = false;
                this.message = {};
