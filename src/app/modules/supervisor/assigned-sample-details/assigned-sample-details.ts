...
// doc.save('savePDF.pdf');
  ...
  generatePDF() {
    const doc = new jsPDF(); // or const doc = new html2pdf();

    const pdfContent = document.getElementById('pdf-content');
    pdfContent.innerHTML= '<div style="text-align: center; "> <h1 style=" margin:auto; text-align: center;">National Food and Feed Reference Laboratory</h1> <p style="text-align: center; font-weight: bold; font-size: 20px; margin: 0;">TEST REPORT</p> </div>'
